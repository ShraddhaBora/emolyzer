    ...
    return (
        ...
        >
            <AnimatePresence mode="wait">
                ...
                {loading && (
                    <LoadingState key="loading" label="Loading dataset…" />
                )}
                    ...
                    <motion.div key="content" initial={false} animate={{}}>
                        ...
                        <section className="hero" style={{ paddingTop: 0 }}>
                            ...
                            <motion.p {...f(0.18)}>
                                ...
                                {data.total?.toLocaleString()} labelled examples
                                across {data.num_classes} emotion classes,
                                sourced from Twitter datasets, GoEmotions
                                (Reddit), and the DAIR-AI emotion corpus.
                            </motion.p>
                        </section>
                        ...
                        >
                            {[
                                ...
                                { value: 3, label: 'Source Datasets', d: 0.4 },
                            ].map(({ value, label, d }) => (
                                <motion.div
                                    key={label}
                                    {...f(d)}
                        ...
                        {/* Bar chart */}
                        <motion.div {...f(0.5)} className="card">
